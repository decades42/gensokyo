...
namespace gensokyo::impl
{
    class Memory
    {
      public:
        ...
        gensokyo::Address get_vfunc_address(gensokyo::Address vtable)
        {
        ...
        constexpr T virtual_call(void* vtable, Args... args)
        {
        ...
        template <typename T, size_t Index, typename... Args>
        constexpr T virtual_ccall(void* vtable, Args... args)
        {
...
namespace gensokyo
{
    inline std::unique_ptr<impl::Memory> memory {};
}